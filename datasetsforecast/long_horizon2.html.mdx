---
description: >-
  Download original ETTh1, ETTh2, ETTm1, ETTm2, Weather, ILI, and TrafficL benchmark datasets used by NHITS, Autoformer, Informer, PatchTST, and TiDE.
title: Long-horizon benchmark datasets for time series
---
