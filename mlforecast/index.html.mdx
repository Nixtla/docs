---
description: MLForecast is a scalable Python framework for time series forecasting with machine learning, supporting pandas, polars, Spark, Dask, and Ray backends.
