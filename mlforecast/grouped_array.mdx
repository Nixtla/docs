---
title: GroupedArray
description: GroupedArray stores multiple time series in one flat data array plus indptr boundaries, enabling fast iteration, transforms, and lag features across groups.
---
