...
the [Lag transformations](/mlforecast/docs/how-to-guides/lag_transforms_guide.html)
how-to guide.
...
See the [Pooled lag transforms](/mlforecast/docs/how-to-guides/pooled_lag_transforms.html)
