---
description: Reference for the mlforecast.lag_transforms module, including rolling, expanding, exponentially weighted, and seasonal statistics used as forecast features.
output-file: lag_transforms.html
title: Lag transforms reference for MLForecast features
---
