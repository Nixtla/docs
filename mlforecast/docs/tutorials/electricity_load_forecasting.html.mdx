---
title: Hourly electricity load forecasting with MLForecast
description: Forecast hourly PJM electricity load with MLForecast using multiple seasonalities and benchmark accuracy and speed against the Prophet library on energy data.
---
