---
title: Detect electricity demand peaks in ERCOT with LightGBM
description: Forecast day-ahead ERCOT electricity load with LightGBM and MLForecast cross-validation to detect coincident peak demand hours and reduce utility bills.
---
