---
title: Probabilistic forecasting with prediction intervals
description: Add probabilistic prediction intervals to MLForecast sklearn models using conformal prediction to quantify forecast uncertainty at configurable levels.
---
