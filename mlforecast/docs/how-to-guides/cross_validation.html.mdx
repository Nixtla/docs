---
title: Time series cross-validation with MLForecast
description: Evaluate MLForecast models with time series cross-validation using sliding windows on the M4 hourly dataset for robust backtesting and model selection.
---
