...
The
[`DistributedMLForecast`](distributed.forecast.html#distributedmlforecast)
...
and
[`DaskXGBForecast`](distributed.models.dask.xgb.html#daskxgbforecast)
...
[`DistributedMLForecast.save`](distributed.forecast.html#distributedmlforecast.save)
...
implementations are in
[`SparkLGBMForecast`](distributed.models.spark.lgb.html#sparklgbmforecast)
and
[`SparkXGBForecast`](distributed.models.spark.xgb.html#sparkxgbforecast)
which are just wrappers around the native implementations.
