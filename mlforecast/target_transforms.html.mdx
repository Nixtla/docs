---
description: API reference for MLForecast target transforms including Differences, LocalStandardScaler, and BoxCox to remove trend and stabilize target variance.
