---
description: LightGBMCV runs time series cross-validation for LightGBM boosters with lag features, target transforms, early stopping, and per-window metric evaluation.
output-file: lgb_cv.html
title: LightGBMCV cross-validation for boosters
---
