---
title: DistributedMLForecast pipeline reference
description: Reference for the DistributedMLForecast class that runs the MLForecast training and prediction pipeline on Spark, Dask, or Ray clusters.
---
