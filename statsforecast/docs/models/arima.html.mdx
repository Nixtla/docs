---
description: Step-by-step ARIMA modeling guide for time series analysis using StatsForecast, focusing on parameter tuning, stationarity, and model validation.
