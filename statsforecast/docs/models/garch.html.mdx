---
title: GARCH for conditional variance forecasting
description: Reference for the GARCH model in StatsForecast covering conditional variance, volatility clustering, parameter fitting, and probabilistic forecasts.
---
