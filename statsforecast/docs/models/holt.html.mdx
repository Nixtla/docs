---
title: Holt linear trend exponential smoothing model
description: Reference for the Holt linear trend model in StatsForecast, an exponential smoothing method with level and trend components for non-seasonal forecasting.
---
