---
title: Forecast M5 at scale with StatsForecast and Ray
description: Benchmark forecasting thousands of M5 time series in under six minutes with StatsForecast ETS on a Ray cluster, faster than Prophet on Spark.
---
