---
title: AutoARIMA benchmark vs Prophet and pmdarima
description: Benchmark Nixtla AutoARIMA against pmdarima and Prophet on the M4 Hourly dataset in StatsForecast, comparing runtime and forecast accuracy at scale.
---
