...
description: Tutorial on rolling-window time series cross-validation in StatsForecast to backtest, compare, and evaluate forecasting model accuracy on historical data.
---
