---
title: Electricity load forecasting with MSTL
description: Forecast hourly PJM electricity load with the MSTL model to capture daily and weekly seasonalities, benchmarked against Prophet and NeuralProphet.
---
