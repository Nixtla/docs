...
description: Model hourly time series with daily and weekly patterns using the MSTL decomposition, a faster and more accurate alternative to Prophet and NeuralProphet.
---
