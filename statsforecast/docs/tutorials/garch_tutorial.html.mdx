---
title: Forecasting volatility with GARCH and ARCH
description: Tutorial for forecasting stock market volatility on S&P 500 and equity returns using GARCH and ARCH conditional heteroskedasticity models in StatsForecast.
---
