---
title: Detect electricity demand peaks in ERCOT
description: Forecast day-ahead ERCOT electricity demand with an MSTL model to detect coincident peaks and reduce electricity bills through smart consumption timing.
---
