---
title: Cache Numba JIT compilation in StatsForecast
description: Enable NIXTLA_NUMBA_CACHE and NUMBA_CACHE_DIR to persist StatsForecast Numba JIT-compiled functions across sessions and cut cold-start compilation overhead.
---
