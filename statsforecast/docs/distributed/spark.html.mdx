---
title: Distributed forecasting on Spark with StatsForecast
description: Run StatsForecast distributedly on Apache Spark through the Fugue backend to forecast millions of time series with AutoARIMA, AutoETS, and MSTL models.
---
