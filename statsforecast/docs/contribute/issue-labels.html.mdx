...
description: Reference for GitHub issue labels used across Nixtla repositories, including first-timers-only, good first issue, help wanted, bug, and documentation.
---
