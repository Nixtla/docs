---
description: Lightning fast Python library for statistical and econometric forecasting with AutoARIMA, AutoETS, MSTL, Theta, and probabilistic prediction intervals.
