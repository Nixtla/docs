...
-   [`StatsForecast.forecast`](src/core/core.html#statsforecast.forecast)
...
| **Returns** | **StatsForecast** |  | **Returns with stored [`StatsForecast`](src/core/core.html#statsforecast) fitted `models`.** |
...
[`StatsForecast.forecast_fitted_values`](src/core/core.html#statsforecast.forecast_fitted_values)
method.\*
