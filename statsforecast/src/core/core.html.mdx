---
description: >-
  Reference for the StatsForecast core class covering fit, predict, forecast, cross_validation, and plot methods for statistical time series models at scale.
output-file: core.html
title: StatsForecast core class fit, predict, and forecast API
---
