...
title: Fugue backend for distributed StatsForecast
description: Distribute StatsForecast across Spark, Dask, or Ray with the FugueBackend class for parallel cross-validation and large-scale time series forecasting.
---
