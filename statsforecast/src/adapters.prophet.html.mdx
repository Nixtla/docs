...
[`AutoARIMAProphet`](src/adapters.prophet.html#autoarimaprophet)
...
| mcmc_samples | int | 0 |  |
| interval_width | float | 0.8 | Uncertainty forecast intervals width. [`StatsForecast`](src/core/core.html#statsforecast)’s level |
...
| **Returns** | **AutoARIMAProphet** |  | **Adapter object with [`AutoARIMA`](src/core/models.html#autoarima) fitted model.** |
