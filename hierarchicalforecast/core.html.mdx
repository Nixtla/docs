---
title: HierarchicalReconciliation core API
description: API reference for the HierarchicalReconciliation class that reconciles base forecasts across hierarchical time series levels using pandas DataFrames.
---
