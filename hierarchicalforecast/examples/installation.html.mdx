---
title: Install HierarchicalForecast with pip or conda
description: Install HierarchicalForecast with pip, conda, or uv, plus source-install instructions for cloning the repo and creating a virtual environment.
---
