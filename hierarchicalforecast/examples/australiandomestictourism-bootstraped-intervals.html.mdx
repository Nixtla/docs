---
title: Bootstrap probabilistic reconciliation example
description: Worked example applying bootstrap-based probabilistic hierarchical reconciliation to Australian domestic tourism data, producing coherent prediction intervals.
---
