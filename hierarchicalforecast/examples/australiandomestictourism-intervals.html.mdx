---
title: Normality-based probabilistic reconciliation example
description: Worked example generating coherent hierarchical prediction intervals for Australian domestic tourism using the Normality probabilistic reconciliation method.
---
