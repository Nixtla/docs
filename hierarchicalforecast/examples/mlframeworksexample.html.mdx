---
description: Combine HierarchicalForecast reconciliation with NBEATS from NeuralForecast and XGBRegressor from MLForecast on the TourismLarge hierarchical dataset.
title: Reconcile NeuralForecast and MLForecast base predictions
---
