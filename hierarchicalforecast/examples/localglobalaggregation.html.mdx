---
description: Compare local and global strategies for temporal hierarchical aggregation on synthetic daily time series using HierarchicalForecast reconciliation.
title: Local vs global temporal aggregation strategies
---
