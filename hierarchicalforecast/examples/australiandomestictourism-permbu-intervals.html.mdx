---
title: PERMBU probabilistic reconciliation example
description: Worked example using the PERMBU method to produce coherent probabilistic hierarchical forecasts and prediction intervals on Australian domestic tourism data.
---
