...
title: Hierarchical forecast evaluation API
description: API reference for the evaluate function and hierarchical evaluation utilities that score reconciled forecasts across aggregation levels and metrics.
---
