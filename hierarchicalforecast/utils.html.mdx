...
title: Aggregation and visualization utilities
description: API reference for the aggregate function, plotting helpers, and dataset utilities to wrangle and visualize hierarchical time series in HierarchicalForecast.
---
