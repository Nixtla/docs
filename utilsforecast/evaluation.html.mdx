---
title: Evaluate forecast accuracy with utilsforecast
sidebarTitle: Evaluation
description: Score forecasts with the utilsforecast evaluate function, computing metrics per series and aggregating results across pandas or polars DataFrames.
---
