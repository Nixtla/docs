...
[`NixtlaClient`](src/nixtla_client.html#nixtlaclient).
...
[\[`NixtlaClient`\](src/nixtla_client.html#nixtlaclient)](https://nixtlaverse.nixtla.io/nixtla/nixtla_client.html#nixtlaclient):
