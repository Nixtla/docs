---
description: >-
  NLinear is a normalized linear model for long-horizon forecasting that handles distribution shifts with simple subtraction-addition normalization at inference.
output-file: models.nlinear.html
title: NLinear normalized linear forecasting model
---
