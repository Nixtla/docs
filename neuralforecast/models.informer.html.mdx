---
description: Informer is an efficient Transformer using ProbSparse self-attention to reduce O(L^2) complexity for scalable long-sequence time series forecasting.
output-file: models.informer.html
title: Informer efficient Transformer for long-horizon forecasts
---
