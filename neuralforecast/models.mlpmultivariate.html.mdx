---
description: >-
  MLPMultivariate is a multi-layer perceptron that predicts all time series jointly, using shared feedforward layers for multivariate forecasting.
output-file: models.mlpmultivariate.html
title: MLPMultivariate joint multivariate forecasting model
---
