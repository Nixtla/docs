---
description: >-
  DilatedRNN uses dilated skip connections to model long time series sequences, mitigating vanishing gradients and improving computational efficiency.
output-file: models.dilated_rnn.html
title: DilatedRNN model for long-sequence forecasting
---
