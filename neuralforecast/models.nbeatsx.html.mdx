---
description: Neural basis expansion analysis with exogenous variables uses MLP blocks and interpretable trend and seasonality decomposition for time series forecasting.
output-file: models.nbeatsx.html
title: NBEATSx neural basis expansion with exogenous inputs
---
