---
description: iTransformer inverts the Transformer, applying attention across series and feed-forward across time for accurate multivariate time series forecasting.
output-file: models.itransformer.html
title: iTransformer inverted Transformer for multivariate series
---
