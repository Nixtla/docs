---
description: >-
  SOFTSSharp extends SOFTS with stochastic variable-position embeddings and dropout inside the STAD block for accurate linear-complexity multivariate forecasts.
output-file: models.softssharp.html
title: SOFTSSharp stochastic SOFTS forecasting model
---
