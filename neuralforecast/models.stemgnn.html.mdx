---
description: Spectral Temporal Graph Neural Network learning multivariate temporal dependencies and inter-series correlations via Graph and Discrete Fourier Transforms.
output-file: models.stemgnn.html
title: StemGNN spectral temporal graph forecasting model
---
