---
description: >-
  DeepAR is a probabilistic autoregressive RNN that uses Monte Carlo sampling and distribution outputs to quantify forecast uncertainty for time series.
output-file: models.deepar.html
title: DeepAR probabilistic RNN forecasting model
---
