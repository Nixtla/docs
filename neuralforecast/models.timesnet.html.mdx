---
description: >-
  TimesNet uses 2D-variation modeling with Inception blocks to capture intraperiod and interperiod temporal patterns for univariate time series forecasting.
output-file: models.timesnet.html
title: TimesNet 2D-variation forecasting model
---
