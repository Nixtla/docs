---
description: >-
  GRU is a Gated Recurrent Unit model for sequential forecasting. It improves on LSTM with a simplified gating mechanism and an MLP decoder for predictions.
output-file: models.gru.html
title: GRU gated recurrent unit forecasting model
---
