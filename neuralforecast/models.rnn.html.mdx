---
description: >-
  RNN is the classic Elman recurrent neural network for time series forecasting, with tanh or ReLU activations and an MLP decoder over stacked layers.
output-file: models.rnn.html
title: RNN Elman recurrent network forecasting model
---
