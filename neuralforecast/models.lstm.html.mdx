---
description: >-
  LSTM is a Long Short-Term Memory recurrent network for time series forecasting, with a multilayer encoder-decoder that handles vanishing gradients.
output-file: models.lstm.html
title: LSTM recurrent neural network forecasting model
---
