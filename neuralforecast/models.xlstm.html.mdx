---
description: >-
  xLSTM extends the LSTM architecture with exponential gating and new sLSTM and mLSTM memory cells for parallelizable sequence modeling and forecasting.
output-file: models.xlstm.html
title: xLSTM extended long short-term memory model
---
