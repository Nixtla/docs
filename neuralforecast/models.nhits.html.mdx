---
description: >-
  Neural Hierarchical Interpolation for Time Series (NHITS) uses MLPs with multi-rate signal processing for long-horizon forecasting 50x faster than Informer.
output-file: models.nhits.html
title: NHITS neural hierarchical interpolation for forecasts
---
