---
description: PatchTST is a patch-based Transformer using channel-independent embeddings for scalable, accurate long-horizon multivariate time series forecasting.
output-file: models.patchtst.html
title: PatchTST patch-based Transformer for long-horizon forecasts
---
