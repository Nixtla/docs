---
description: Temporal Fusion Transformer (TFT) combines LSTM encoders, multi-head attention, and variable selection for interpretable multi-horizon forecasting.
output-file: models.tft.html
title: TFT Temporal Fusion Transformer for interpretable forecasts
---
