---
description: >-
  TSMixerx extends TSMixer with exogenous variables, combining MLP-based temporal-feature mixing with static and future covariate support for forecasts.
output-file: models.tsmixerx.html
title: TSMixerx MLP forecasting with exogenous variables
---
