---
description: Kolmogorov-Arnold Networks (KAN) replace MLPs with learnable activations, offering an expressive alternative for non-linear time series forecasting.
output-file: models.kan.html
title: KAN Kolmogorov-Arnold network for time series forecasting
---
