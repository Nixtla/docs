---
description: >-
  TimeXer is a cross-series attention transformer for multivariate time series forecasting, using patch-based processing and exogenous variable support.
output-file: models.timexer.html
title: TimeXer transformer for multivariate forecasting
---
