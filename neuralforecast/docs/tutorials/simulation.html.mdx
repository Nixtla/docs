---
title: Generate simulation paths for probabilistic forecasts
description: Use NeuralForecast to generate correlated sample paths for scenario analysis, compare simulations with prediction intervals, and quantify future uncertainty.
---
