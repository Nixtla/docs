---
title: Adding new deep learning models to NeuralForecast
description: Contributor guide to adding new PyTorch models to NeuralForecast, covering BaseModel classes, forward method, training hooks, and integration tests.
---
