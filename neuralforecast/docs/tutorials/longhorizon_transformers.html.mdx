...
description: Train and evaluate Informer, Autoformer, FEDformer, and PatchTST Transformer models on the ETTm2 benchmark for accurate long-horizon time series forecasting.
---
