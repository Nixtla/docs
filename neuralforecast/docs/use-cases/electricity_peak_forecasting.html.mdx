---
title: Detect ERCOT electricity peaks with NeuralForecast
description: Forecast ERCOT Texas electricity load with NeuralForecast deep learning models to detect daily coincident peaks and reduce peak demand tariff costs.
---
