---
description: Evaluate deep learning forecast models in NeuralForecast with cross-validation, using rolling windows and sliding origins to backtest on historical data.
title: Cross-validation for time series forecasts
---
