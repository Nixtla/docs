---
description: >-
  NBEATS Neural Basis Expansion Analysis uses MLP blocks with residual links and interpretable or generic configurations for M3 and M4 competition performance.
output-file: models.nbeats.html
title: NBEATS neural basis expansion forecasting model
---
