---
description: >-
  TCN is a Temporal Convolutional Network that uses dilated causal convolutions to capture long-range dependencies for efficient time series forecasting.
output-file: models.tcn.html
title: TCN temporal convolutional forecasting model
---
