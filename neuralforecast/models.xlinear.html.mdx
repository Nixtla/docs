---
description: >-
  XLinear is an MLP-based multivariate forecasting model that uses temporal and cross-channel gating with a global token to capture patterns across time series.
output-file: models.xlinear.html
title: XLinear gated MLP model for multivariate forecasts
---
