...
description: ExogenousConfig and CorrelatedExogConfig control calendar features, cyclical encodings, anomaly and changepoint flags, and correlated exogenous columns.
---
