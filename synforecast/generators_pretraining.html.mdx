...
description: TSIGenerator, TCMGenerator, and KernelSynthGenerator compose randomized trend-seasonal, causal-graph, and GP-kernel processes for foundation-model pretraining.
---
