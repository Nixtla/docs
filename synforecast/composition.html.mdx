...
description: Reference for generate_series, balanced_pool, pretraining_pool, and Multivariatizer helpers that build panels and correlated channels from generators.
---
