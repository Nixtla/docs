...
description: Statistical generators covering random walks, seasonal signals, SARIMA, exponential smoothing (ETS), and integer-valued autoregressive INAR counts.
---
