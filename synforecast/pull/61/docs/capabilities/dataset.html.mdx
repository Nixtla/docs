...
> **SynSet vs. interpretable_pool vs. generate_series**
>
> `SynSet` is the low-level composer you control directly.
> [`interpretable_pool`](./balanced_pool.html) is a ready-made list of
> 42 generators you can drop into a `SynSet`, and
> [`generate_series`](../getting-started/quickstart.html) wraps that
> pool in a one-liner. Use `SynSet` when you want an explicit, curated
> mix of generators.
