...
> **Related generators**
>
> -   [SARIMA](./sarima.html) — seasonality with
>     autoregressive/moving-average dynamics instead of a fixed wave.
> -   [ETS](./ets.html) — seasonality through exponential-smoothing
>     state-space models.
> -   Layer on [anomalies](../../capabilities/anomalies.html) or
>     [changepoints](../../capabilities/changepoints.html) to
>     stress-test a seasonal model.
