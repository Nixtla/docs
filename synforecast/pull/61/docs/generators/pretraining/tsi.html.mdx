...
> **Related generators**
>
> -   [TCM](./tcm.html) — random causal-graph dynamics;
>     [KernelSynth](./kernel_synth.html) — Gaussian-process kernel
>     compositions.
> -   [MAR](./mar.html) — mixtures of stationary AR components with
>     optional feature targeting.
> -   [Interpretable pool](../../capabilities/balanced_pool.html) —
>     interpretable single-mechanism generators for benchmarking.
>
