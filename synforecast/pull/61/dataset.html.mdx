...
Name | Type | Description | Default
---- | ---- | ----------- | -------
`df` | <code>[IntoFrameT](#narwhals.stable.v2.typing.IntoFrameT)</code> | Input frame containing the configured ID, time and target columns. | *required*
`n_augment` | <code>[int](#int)</code> | Copies per usable source, from 1 to 1000 (default: 1). | <code>1</code>
`seasonal_period` | <code>[int](#int) \| None</code> | Period >= 2, or None to detect it per source. | <code>None</code>
`block_size` | <code>[int](#int) \| None</code> | Block length >= 2, or None for the period/length-based default. Explicit lengths are also capped as described above. | <code>None</code>
`include_original` | <code>[bool](#bool)</code> | Include unchanged original rows (default: True). | <code>True</code>

**Returns:**

Type | Description
---- | -----------
<code>[IntoFrameT](#narwhals.stable.v2.typing.IntoFrameT)</code> | Frame containing generated series and, optionally, original rows,
<code>[IntoFrameT](#narwhals.stable.v2.typing.IntoFrameT)</code> | using the configured output engine or the input engine.

**Raises:**

Type | Description
---- | -----------
<code>[ValueError](#ValueError)</code> | For invalid arguments, missing required columns, infinite target values, or no usable source series.
...
---- | ---- | ----------- | -------
`df` | <code>[IntoFrameT](#narwhals.stable.v2.typing.IntoFrameT)</code> | Input frame containing the configured ID, time and target columns. | *required*
`n_augment` | <code>[int](#int)</code> | Copies per usable reference, from 1 to 1000 (default: 1). | <code>1</code>
`n_neighbors` | <code>[int](#int)</code> | Positive maximum neighbor count (default: 3), capped at the number of other usable sources. | <code>3</code>
`n_iterations` | <code>[int](#int)</code> | Barycenter updates, from 1 to 1000 (default: 5). | <code>5</code>
`window_fraction` | <code>[float](#float)</code> | DTW band fraction in (0, 1] (default: 0.1). | <code>0.1</code>
`scale` | <code>[Literal](#typing.Literal)['reference', 'none']</code> | "reference" to restore reference scale (default), or "none" to average raw values. | <code>'reference'</code>
`include_original` | <code>[bool](#bool)</code> | Include unchanged original rows (default: True). | <code>True</code>
...
Type | Description
---- | -----------
<code>[ValueError](#ValueError)</code> | For invalid arguments, missing required columns, infinite target values, excessive alignment/output storage, or fewer than two usable source series.
