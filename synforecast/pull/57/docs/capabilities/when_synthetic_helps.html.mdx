...
>     [TCM](../generators/pretraining/tcm),
>     [KernelSynth](../generators/pretraining/kernel_synth), and
>     [MAR](../generators/pretraining/mar) — exist to pretrain models
>     that transfer to unseen series. The section below measures this: a
>     synthetic-pretrained model used zero-shot beats training from
>     scratch when the real history is short.
