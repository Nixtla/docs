...
-   [Changepoints](../../synforecast/docs/capabilities/changepoints.html),
    [anomalies](../../synforecast/docs/capabilities/anomalies.html), and
    [missingness](../../synforecast/docs/capabilities/missingness.html)
    — the injection this generator inherits.
-   [Exogenous
    variables](../../synforecast/docs/capabilities/exogenous.html) —
    datetime features, correlated regressors, and the ground-truth flags
    used above.
-   [Compose a
    dataset](../../synforecast/docs/capabilities/dataset.html) — combine
    your generator with others in a `SynSet`.
