...
>     — the injection knobs used here, each with a ground-truth flag
>     column.
> -   [When does synthetic data
>     help?](../../synforecast/docs/capabilities/when_synthetic_helps.html)
>     — the accuracy picture, and the uses that sit outside it.
