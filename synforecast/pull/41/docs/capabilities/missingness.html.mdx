...
>
> -   [Multivariate
>     missingness](../../synforecast/docs/capabilities/multivariate_missingness.html)
>     — coordinated gaps across channels (e.g. a whole sensor dropping
>     out).
> -   [Anomalies](../../synforecast/docs/capabilities/anomalies.html)
>     and
>     [changepoints](../../synforecast/docs/capabilities/changepoints.html)
>     compose with missing data for realistic test series.
