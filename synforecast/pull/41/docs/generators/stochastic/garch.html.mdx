...
>
> -   [Stochastic
>     volatility](../../../synforecast/docs/generators/stochastic/stochastic_volatility.html)
>     — latent-process volatility (Heston / SABR) rather than GARCH
>     recursion.
> -   [Levy
>     process](../../../synforecast/docs/generators/stochastic/levy_process.html)
>     — heavy tails without the clustering.
>
