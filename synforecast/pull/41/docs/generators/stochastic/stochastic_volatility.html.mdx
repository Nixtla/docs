...
>     — deterministic-recursion volatility clustering.
> -   [Ornstein-Uhlenbeck](../../../synforecast/docs/generators/stochastic/ornstein_uhlenbeck.html)
>     — the mean-reverting process often used for the latent variance.
>
