...
>     — dependence that plays out *over time* (lead-lag), not just
>     contemporaneously.
> -   [Multivariatize](../../../synforecast/docs/capabilities/multivariatize.html)
>     — turn any univariate generator into coupled channels.
>
