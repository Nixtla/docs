...
>     — *random compositions* of these kernels for pretraining corpora.
> -   [Cyclic](../../../synforecast/docs/generators/stochastic/cyclic.html)
>     — irregular oscillation without a fixed kernel.
>
