...
-   [NeuralForecast](../../synforecast/docs/integrations/neuralforecast.html):
    zero-shot synthetic pretraining and synthetic pretraining followed
    by fine-tuning.
-   [MLForecast](../../synforecast/docs/integrations/mlforecast.html):
    global training with augmentation and zero-shot transfer through
    `predict(new_df=...)`.
-   [StatsForecast](../../synforecast/docs/integrations/statsforecast.html):
    local-model behavior and a synthetic-history ensemble instead of
    transferable pretraining.
