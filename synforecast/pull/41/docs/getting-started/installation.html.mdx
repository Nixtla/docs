...
-   [Quick
    start](../../synforecast/docs/getting-started/quickstart.html) —
    generate a panel and control the generators.
-   [Balanced
    pool](../../synforecast/docs/capabilities/balanced_pool.html) — what
