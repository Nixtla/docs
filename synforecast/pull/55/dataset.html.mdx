...
`n_iterations` | <code>[int](#int)</code> | Positive number of barycenter updates (default: 5). | <code>5</code>
...
Type | Description
---- | -----------
<code>[ValueError](#ValueError)</code> | For invalid arguments, missing required columns, infinite target values, or fewer than two usable source series.
