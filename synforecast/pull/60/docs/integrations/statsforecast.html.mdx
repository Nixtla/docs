...
series — see the [MLForecast](./mlforecast.html) and
[NeuralForecast](./neuralforecast.html) guides. Synthetic panels are
also useful here for stress testing: inject
[anomalies](../capabilities/anomalies.html) or
[changepoints](../capabilities/changepoints.html) with known positions
and measure how far the fitted model moves.
