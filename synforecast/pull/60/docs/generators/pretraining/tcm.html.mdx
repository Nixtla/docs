...
> **Related generators**
>
> -   [TSI](./tsi.html) — trend/seasonal/irregular composition;
>     [KernelSynth](./kernel_synth.html) — GP kernel compositions.
> -   [MAR](./mar.html) — mixtures of stationary AR components with
>     optional feature targeting.
> -   [VAR](../multivariate/var.html) — linear multivariate dynamics
>     without a random causal graph.
>
