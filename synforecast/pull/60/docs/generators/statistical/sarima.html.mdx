...
> **Related generators**
>
> -   [ETS](./ets.html) — the exponential-smoothing counterpart for
>     trend and seasonality.
> -   [Seasonal](./seasonal.html) — a simpler fixed seasonal wave
>     without ARMA dynamics.
> -   [Random walk](./random_walk.html) — the special case ARIMA(0, 1,
>     0).
>
