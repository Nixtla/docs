...
> **Related generators**
>
> -   [GARCH](./garch.html) — deterministic-recursion volatility
>     clustering.
> -   [Ornstein-Uhlenbeck](./ornstein_uhlenbeck.html) — the
>     mean-reverting process often used for the latent variance.
>
