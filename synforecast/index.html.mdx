...
description: SynForecast generates synthetic time-series panels with 31 statistical, stochastic, and multivariate generators, plus SynAugment for augmenting observed data.
---
