---
title: Dataset composition and augmentation
description: SynSet composes multiple generators into one panel; SynAugment analyzes series, fits generators, and produces statistically similar synthetic augmentations.
---
