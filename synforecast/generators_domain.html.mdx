...
description: Domain generators for intermittent demand, IoT sensors, energy load, state-space models, daily active users, vital signs, and web clickstream traffic.
---
