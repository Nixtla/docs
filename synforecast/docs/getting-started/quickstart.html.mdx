---
title: "SynForecast quickstart for synthetic time series"
description: "Generate synthetic time-series panels with SynForecast: one-line generation, explicit generators, injected anomalies, and mixed SynSet datasets."
---
