...
description: "Use synthetic panels with StatsForecast local models like AutoETS: augmentation is inert, so validate pipelines against known ETS processes instead."
---
...
[anomalies](../capabilities/anomalies) or
