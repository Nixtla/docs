...
description: "Train MLForecast global models with SynAugment augmentation and zero-shot pretraining on synthetic panels, benchmarked on the airline passenger series."
---
