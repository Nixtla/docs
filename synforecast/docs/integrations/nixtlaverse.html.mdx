...
-   [NeuralForecast](/synforecast/docs/integrations/neuralforecast.html): zero-shot synthetic
    pretraining and synthetic pretraining followed by fine-tuning.
-   [MLForecast](/synforecast/docs/integrations/mlforecast.html): global training with augmentation
