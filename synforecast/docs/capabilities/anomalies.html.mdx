...
description: Inject spikes, dips, and level shifts into synthetic time series with known locations to benchmark anomaly detectors and stress-test forecasters.
---
