...
description: Inject random, block, or seasonal missing value patterns into synthetic series to test imputation methods and forecaster tolerance for gaps.
---
...
>
> -   [Multivariate missingness](multivariate_missingness) — coordinated
>     gaps across channels (e.g. a whole sensor dropping out).
> -   [Anomalies](anomalies) and [changepoints](changepoints) compose
