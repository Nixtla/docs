...
>
> -   [Multivariate missingness](./multivariate_missingness.html) —
>     coordinated gaps across channels (e.g. a whole sensor dropping
>     out).
> -   [Anomalies](./anomalies.html) and
>     [changepoints](./changepoints.html) compose with missing data for
>     realistic test series.
