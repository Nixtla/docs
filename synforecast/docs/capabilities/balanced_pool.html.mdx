...
[`generate_series`](/synforecast/docs/getting-started/quickstart.html), and a bias-free
...
[when synthetic data helps](/synforecast/docs/capabilities/when_synthetic_helps.html) for a paired,
