...
from 15 of SynForecast’s 32 generator classes with one class per
...
> with `balanced_pool` included by default.
...
adds independently-seeded copies of the four meta-generators
