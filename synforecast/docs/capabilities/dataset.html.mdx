...
description: Combine several generators into one long-format panel with SynSet to mix behaviors like random walks and seasonal demand in one model-ready frame.
---
