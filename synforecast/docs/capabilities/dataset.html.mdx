...
> [`balanced_pool`](/synforecast/docs/capabilities/balanced_pool.html) is a ready-made list of 42 generators
> you can drop into a `SynSet`, and
> [`generate_series`](/synforecast/docs/getting-started/quickstart.html) wraps that pool in
