...
>
> -   [Anomalies](/synforecast/docs/capabilities/anomalies.html), [changepoints](/synforecast/docs/capabilities/changepoints.html), and
>     [missingness](/synforecast/docs/capabilities/missingness.html) — the injection knobs used here, each
>     with a ground-truth flag column.
> -   [When does synthetic data help?](/synforecast/docs/capabilities/when_synthetic_helps.html) — the
