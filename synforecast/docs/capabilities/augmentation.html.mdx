...
>     end.
> -   **[`mbb`](./nonparametric_augmentation.html)** — resample blocks
>     from each series’ decomposed remainder.
> -   **[`dba`](./nonparametric_augmentation.html)** — build randomized
>     DTW barycenters from nearby panel series.
>
