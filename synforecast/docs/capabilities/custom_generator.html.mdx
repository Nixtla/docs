...
-   [Changepoints](./changepoints.html), [anomalies](./anomalies.html),
    and [missingness](./missingness.html) — the injection this generator
    inherits.
-   [Exogenous variables](./exogenous.html) — datetime features,
    correlated regressors, and the ground-truth flags used above.
-   [Compose a dataset](./dataset.html) — combine your generator with
    others in a `SynSet`.
