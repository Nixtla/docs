...
description: Subclass BaseGenerator to add a custom data-generating process where one method wires up seeding, timestamps, pattern injection, and dataframe engines.
---
