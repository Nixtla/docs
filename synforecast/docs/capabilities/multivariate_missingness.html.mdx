...
description: Apply per-channel missingness to VAR and copula generators while preserving cross-series correlation for multivariate imputation benchmarks.
---
