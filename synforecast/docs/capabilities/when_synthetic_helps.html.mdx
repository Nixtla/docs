...
>     [`generate_series`](/synforecast/docs/getting-started/quickstart.html) and the
>     [balanced pool](/synforecast/docs/capabilities/balanced_pool.html) span behaviors — volatility
...
> -   **Robustness testing.** Inject [anomalies](/synforecast/docs/capabilities/anomalies.html),
>     [changepoints](/synforecast/docs/capabilities/changepoints.html), and [missingness](/synforecast/docs/capabilities/missingness.html) with
...
>     [KernelSynth](/synforecast/docs/generators/pretraining/kernel_synth.html) — exist to
...
corpus from [`pretraining_pool()`](/synforecast/docs/capabilities/balanced_pool.html), then forecast M3
