...
description: Wrap any univariate generator with Multivariatizer to couple channels via contemporaneous mixing or lead-lag lags for realistic cross-dependencies.
---
