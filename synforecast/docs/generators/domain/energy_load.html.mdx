---
title: Energy load generator for multi-seasonal grid demand
description: Generate electricity load with layered daily and weekly seasonality, temperature sensitivity, holiday effects, and residential or industrial demand shapes.
---
