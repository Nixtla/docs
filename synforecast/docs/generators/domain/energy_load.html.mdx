...
> **Related generators**
>
> -   [Seasonal](/synforecast/docs/generators/statistical/seasonal.html) — a single seasonal cycle.
> -   [SARIMA](/synforecast/docs/generators/statistical/sarima.html) — seasonal ARMA dynamics.
>
