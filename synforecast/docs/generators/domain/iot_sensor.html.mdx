---
title: IoT sensor generator with drift and failure artifacts
description: Generate IoT sensor readings for temperature, humidity, pressure, and light with calibration drift, battery degradation, and intermittent device failures.
---
