...
> **Related generators**
>
> -   [Clickstream](/synforecast/docs/generators/domain/clickstream.html) — the sessionized activity beneath
>     engagement metrics.
> -   [Seasonal](/synforecast/docs/generators/statistical/seasonal.html) — the weekly rhythm in
>     isolation.
>
