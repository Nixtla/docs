---
title: Vital signs generator for clinical monitoring data
description: Generate clinical vital signs like heart rate, blood pressure, SpO2, and respiration with circadian rhythms, HRV, and healthy or septic patient profiles.
---
