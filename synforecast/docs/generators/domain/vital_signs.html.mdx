...
> **Related generators**
>
> -   [Anomalies](/synforecast/docs/capabilities/anomalies.html) — inject labelled events
>     for detector benchmarks.
> -   [IoT sensor](/synforecast/docs/generators/domain/iot_sensor.html) — another instrument-style signal with
>     artifacts.
>
