...
> **Related generators**
>
> -   [Daily active users](/synforecast/docs/generators/domain/daily_active_users.html) — the aggregate
>     engagement metric.
> -   [Poisson process](/synforecast/docs/generators/stochastic/poisson_process.html) — a baseline
>     arrival model.
>
