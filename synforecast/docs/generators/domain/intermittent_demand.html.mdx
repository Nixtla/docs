---
title: Intermittent demand generator for sparse spare-parts series
description: Generate sparse spare-parts demand series with zero-inflated Poisson, negative binomial, lognormal, or gamma order sizes for Croston-style forecasters.
---
