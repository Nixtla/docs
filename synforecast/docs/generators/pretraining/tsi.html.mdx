...
> **Related generators**
>
> -   [TCM](/synforecast/docs/generators/pretraining/tcm.html) — random causal-graph dynamics;
>     [KernelSynth](/synforecast/docs/generators/pretraining/kernel_synth.html) — Gaussian-process kernel
>     compositions.
> -   [Balanced pool](/synforecast/docs/capabilities/balanced_pool.html) — interpretable
