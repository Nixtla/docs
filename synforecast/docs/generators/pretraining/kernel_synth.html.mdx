...
> **Related generators**
>
> -   [TSI](/synforecast/docs/generators/pretraining/tsi.html) and [TCM](/synforecast/docs/generators/pretraining/tcm.html) — the other pretraining generators
>     (component composition and random causal graphs).
> -   [Gaussian process](/synforecast/docs/generators/multivariate/gaussian_process.html) — a single
