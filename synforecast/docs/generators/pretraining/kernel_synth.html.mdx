...
> **Related generators**
>
> -   [TSI](./tsi.html), [TCM](./tcm.html), and [MAR](./mar.html) —
>     component composition, random causal graphs, and AR mixtures.
> -   [Gaussian process](../multivariate/gaussian_process.html) — a
>     single fixed kernel rather than random compositions.
>
