---
title: KernelSynth generator for GP-kernel pretraining series
description: Generate Chronos-style pretraining series from random compositions of Gaussian process kernels combined with additive and multiplicative operators.
---
