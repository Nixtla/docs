---
title: Temporal causal model generator for lagged SCM dynamics
description: Generate temporal structural causal model series from randomly sampled lagged edges with nonlinear edge functions and stochastic node innovations.
---
