...
> **Related generators**
>
> -   [TSI](/synforecast/docs/generators/pretraining/tsi.html) — trend/seasonal/irregular composition;
>     [KernelSynth](/synforecast/docs/generators/pretraining/kernel_synth.html) — GP kernel compositions.
> -   [VAR](/synforecast/docs/generators/multivariate/var.html) — linear multivariate dynamics without
