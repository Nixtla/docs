...
description: Simulate bounded time series in (0, 1) using Beta-AR or logit-normal models for proportions, utilization rates, and market shares with mean reversion.
---
