...
> **Related generators**
>
> -   [GARCH](/synforecast/docs/generators/stochastic/garch.html) — deterministic-recursion volatility clustering.
> -   [Ornstein-Uhlenbeck](/synforecast/docs/generators/stochastic/ornstein_uhlenbeck.html) — the mean-reverting
