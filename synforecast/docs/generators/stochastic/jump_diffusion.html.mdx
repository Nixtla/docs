...
description: Simulate Merton jump-diffusion prices combining continuous drift, Gaussian volatility, and Poisson jumps for shock-prone assets and news-driven gaps.
---
