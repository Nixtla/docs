...
> **Related generators**
>
> -   [Geometric Brownian motion](/synforecast/docs/generators/stochastic/geometric_brownian_motion.html) — the
>     jump-free diffusion.
> -   [Hawkes process](/synforecast/docs/generators/stochastic/hawkes_process.html) — when the jumps cluster and
>     self-excite.
>
