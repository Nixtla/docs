...
> **Related generators**
>
> -   [Changepoints](/synforecast/docs/capabilities/changepoints.html) — one-off
>     structural breaks rather than recurring regimes.
> -   [GARCH](/synforecast/docs/generators/stochastic/garch.html) — smoothly varying volatility instead of discrete
>     states.
>
