...
> **Related generators**
>
> -   [Poisson process](/synforecast/docs/generators/stochastic/poisson_process.html) — the no-excitation baseline.
> -   [Jump diffusion](/synforecast/docs/generators/stochastic/jump_diffusion.html) — continuous dynamics with
>     discrete shocks.
>
