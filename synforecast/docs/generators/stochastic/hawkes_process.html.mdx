...
description: Generate self-exciting Hawkes point process series with clustered event bursts for trades, earthquakes, and social-media cascade arrival modeling.
---
