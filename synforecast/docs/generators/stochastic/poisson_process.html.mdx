...
description: Generate homogeneous Poisson event counts with a constant arrival rate as the memoryless baseline for queues, click streams, and failure processes.
---
