...
> **Related generators**
>
> -   [Hawkes process](/synforecast/docs/generators/stochastic/hawkes_process.html) — arrivals that cluster because
>     each event raises the rate.
> -   [INAR](/synforecast/docs/generators/statistical/inar.html) — autocorrelated integer counts.
>
