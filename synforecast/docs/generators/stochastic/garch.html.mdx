...
description: Generate GARCH(p,q) returns with autocorrelated conditional variance to reproduce volatility clustering and heteroscedastic bursts in financial data.
---
