...
> **Related generators**
>
> -   [Random walk](/synforecast/docs/generators/statistical/random_walk.html) — the `H = 0.5` special
>     case.
> -   [Ornstein-Uhlenbeck](/synforecast/docs/generators/stochastic/ornstein_uhlenbeck.html) — a different route to
>     mean reversion.
>
