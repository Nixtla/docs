...
> **Related generators**
>
> -   [Random walk](/synforecast/docs/generators/statistical/random_walk.html) — the no-reversion limit
>     (`theta` → 0).
> -   [Bounded process](/synforecast/docs/generators/stochastic/bounded_process.html) — mean reversion constrained to
>     an interval.
>
