...
description: Simulate alpha-stable Levy processes with heavy-tailed increments and large jumps, generalizing Brownian motion for extreme moves and Cauchy-like tails.
---
