...
> **Related generators**
>
> -   [Jump diffusion](/synforecast/docs/generators/stochastic/jump_diffusion.html) — a smooth diffusion with
>     separate discrete jumps.
> -   [GARCH](/synforecast/docs/generators/stochastic/garch.html) — heavy-tailed *conditional* behavior via
