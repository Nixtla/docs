---
title: Gaussian process generator with kernel-defined covariance
description: Generate Gaussian process samples with RBF, Matern, or periodic kernels to control smoothness, length scale, and cyclic structure of the covariance.
---
