...
> **Related generators**
>
> -   [Copula](/synforecast/docs/generators/multivariate/copula.html) — contemporaneous dependence without temporal
>     dynamics.
> -   [Multivariatize](/synforecast/docs/capabilities/multivariatize.html) — add coupling
