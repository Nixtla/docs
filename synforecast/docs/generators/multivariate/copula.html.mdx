...
> **Related generators**
>
> -   [VAR](./var.html) — dependence that plays out *over time*
>     (lead-lag), not just contemporaneously.
> -   [Multivariatize](../../capabilities/multivariatize.html) — turn
>     any univariate generator into coupled channels.
>
