---
title: SARIMA
description: Generate SARIMA series from known (p,d,q)(P,D,Q) orders with autocorrelation, differencing, and seasonality for model recovery and forecasting benchmarks.
---
