...
description: Generate integer-valued autoregressive count series via binomial thinning, with Poisson or negative binomial innovations for demand and arrival data.
---
