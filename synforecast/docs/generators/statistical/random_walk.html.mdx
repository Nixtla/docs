...
>
> -   [Geometric Brownian
>     motion](/synforecast/docs/generators/stochastic/geometric_brownian_motion.html) — a
>     *multiplicative* random walk for strictly positive series like
>     prices.
> -   [SARIMA](/synforecast/docs/generators/statistical/sarima.html) with `d=1` — a random walk with added
...
>     [anomalies](/synforecast/docs/capabilities/anomalies.html) options.
>
