---
title: Random walk
description: Simulate a random walk process with configurable drift and volatility. The canonical non-stationary baseline for naive forecasts and unit-root tests.
---
