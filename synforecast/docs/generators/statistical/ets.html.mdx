...
> **Related generators**
>
> -   [SARIMA](/synforecast/docs/generators/statistical/sarima.html) — the ARIMA view of the same trend/seasonal
>     structure.
> -   [Seasonal](/synforecast/docs/generators/statistical/seasonal.html) — a fixed seasonal wave when you don’t need
>     evolving states.
>
