...
description: Simulate ETS state-space series with level, trend, and seasonal components. Covers 30 additive and multiplicative Holt-Winters variants with damping.
---
