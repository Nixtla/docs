---
title: Seasonal
description: Simulate seasonal time series combining periodic waves, linear trend, and additive noise for testing forecast models on daily, weekly, or yearly cycles.
---
